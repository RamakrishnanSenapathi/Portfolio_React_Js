                ...
                <div className="row">
                    ...
                    <div className="col-lg-6 col-md-12 col-sm-12 d-flex align-items-center">
                        <div>
                            ...
                            <hr></hr>
                            <p className='slide-in-bottom'>Iam Student at KPR Instiute Of Engineering and technology, Pursuing 3rd year b.tech in Artificial Intelligence And Data Science
                            </p>
