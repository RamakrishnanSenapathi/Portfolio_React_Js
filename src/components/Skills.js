...
import {SiJavascript,SiNodedotjs,SiReact,SiHtml5,SiCss3,SiBootstrap,SiCsharp,SiMongodb, SiPython, SiJava, SiGooglecolab, SiMysql, SiFlask} from 'react-icons/si'
function Skills() {
  return (
    <Fragment>
